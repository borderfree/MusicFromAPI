...
/* renamed from: com.facebook.ads.internal.r.a.k */
public class C1747k {
    /* renamed from: a */
    private static String m8739a(byte[] bArr, String str) {
    ...
    /* renamed from: a */
    public static void m8740a(HttpsURLConnection httpsURLConnection, Set<String> set, Set<String> set2) {
        if (VERSION.SDK_INT != 15 || !"4.0.3".equals(VERSION.RELEASE)) {
            try {
                ...
                while (i < length) {
                    ...
                    String a = m8739a(x509Certificate.getEncoded(), "SHA-1");
                    if (set == null || !set.contains(a)) {
                        String a2 = m8739a(x509Certificate.getPublicKey().getEncoded(), "SHA-1");
