...
public class C2227k {
    ...
    /* renamed from: a */
    private static final HashSet<String> f7186a = m10215a();

    /* renamed from: a */
    private static HashSet<String> m10215a() {
    ...
    /* renamed from: a */
    public static boolean m10216a(Context context, String str) {
        ...
        try {
            ...
            if (packageInfo.signatures != null && packageInfo.signatures.length > 0) {
                for (Signature byteArray : packageInfo.signatures) {
                    if (!f7186a.contains(C2258x.m10368a(byteArray.toByteArray()))) {
                        return false;
                    }
                }
                return true;
