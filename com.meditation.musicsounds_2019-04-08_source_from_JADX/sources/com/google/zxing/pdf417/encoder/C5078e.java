...
final class C5078e {
    ...
    /* renamed from: a */
    private static final int[][] f18054a;
    ...
    /* renamed from: a */
    static String m25126a(CharSequence charSequence, int i) {
        int a = m25125a(i);
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            while (i3 > 0) {
                cArr[i3] = (char) ((cArr[i3 - 1] + (929 - ((f18054a[i][i3] * charAt) % 929))) % 929);
                i3--;
            }
            cArr[0] = (char) ((929 - ((charAt * f18054a[i][0]) % 929)) % 929);
        }
