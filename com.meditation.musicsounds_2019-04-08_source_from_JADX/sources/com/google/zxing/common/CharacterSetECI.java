...
public enum CharacterSetECI {
    ...
    /* renamed from: a */
    private static final Map<Integer, CharacterSetECI> f17948a = null;

    /* renamed from: b */
    private static final Map<String, CharacterSetECI> f17949b = null;
    ...
    static {
        ...
        for (CharacterSetECI characterSetECI : values()) {
            for (int valueOf : characterSetECI.values) {
                f17948a.put(Integer.valueOf(valueOf), characterSetECI);
            }
            f17949b.put(characterSetECI.name(), characterSetECI);
            for (String put : characterSetECI.otherEncodingNames) {
                f17949b.put(put, characterSetECI);
            }
        }
    }
    ...
    public static CharacterSetECI getCharacterSetECIByName(String str) {
        return (CharacterSetECI) f17949b.get(str);
    }

    public static CharacterSetECI getCharacterSetECIByValue(int i) {
        if (i >= 0 && i < 900) {
            return (CharacterSetECI) f17948a.get(Integer.valueOf(i));
        }
