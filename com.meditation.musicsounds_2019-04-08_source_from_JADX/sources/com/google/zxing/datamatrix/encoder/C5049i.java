...
public final class C5049i {
    ...
    /* renamed from: a */
    private static String m25033a(CharSequence charSequence, int i) {
        return m25034a(charSequence, 0, charSequence.length(), i);
    }

    /* renamed from: a */
    private static String m25034a(CharSequence charSequence, int i, int i2, int i3) {
        int i4 = 0;
        while (true) {
            if (i4 >= f17990a.length) {
                i4 = -1;
                break;
            } else if (f17990a[i4] == i3) {
                break;
            } else {
                i4++;
            }
            ...
            for (int i6 = i; i6 < i + i2; i6++) {
                ...
                while (i7 > 0) {
                    if (charAt == 0 || iArr[i7] == 0) {
                        ...
                        cArr[i7] = (char) (cArr[i7 - 1] ^ f17993d[(f17992c[charAt] + f17992c[iArr[i7]]) % 255]);
                    }
                    i7--;
                }
                if (charAt == 0 || iArr[0] == 0) {
                    ...
                    cArr[0] = (char) f17993d[(f17992c[charAt] + f17992c[iArr[0]]) % 255];
                }
            }
    ...
    /* renamed from: a */
    public static String m25035a(String str, C5051k kVar) {
        if (str.length() == kVar.mo16472f()) {
            StringBuilder sb = new StringBuilder(kVar.mo16472f() + kVar.mo16473g());
            sb.append(str);
            int a = kVar.mo16444a();
            if (a == 1) {
                sb.append(m25033a((CharSequence) str, kVar.mo16473g()));
            } else {
                ...
                while (i < a) {
                    int i2 = i + 1;
                    iArr[i] = kVar.mo16445a(i2);
                    iArr2[i] = kVar.mo16468b(i2);
                    iArr3[i] = 0;
                    if (i > 0) {
                ...
                for (int i3 = 0; i3 < a; i3++) {
                    ...
                    for (int i4 = i3; i4 < kVar.mo16472f(); i4 += a) {
                        sb2.append(str.charAt(i4));
                    }
                    String a2 = m25033a((CharSequence) sb2.toString(), iArr2[i3]);
                    int i5 = i3;
                    int i6 = 0;
                    while (i5 < iArr2[i3] * a) {
                        int i7 = i6 + 1;
                        sb.setCharAt(kVar.mo16472f() + i5, a2.charAt(i6));
                        i5 += a;
                        i6 = i7;
                    }
                }
