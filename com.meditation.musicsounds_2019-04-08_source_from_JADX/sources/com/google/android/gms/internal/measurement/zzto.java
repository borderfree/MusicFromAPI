...
class zzto extends zztn {
    ...
    public final int zza(int i, int i2, int i3) {
        return C4390fo.m21604a(i, this.zzbtx, zzug(), i3);
    }
    ...
    public final void zza(C4350eh ehVar) {
        ehVar.mo14327a(this.zzbtx, zzug(), size());
    }
    ...
    public final zzte zzb(int i, int i2) {
        ...
        return zzb == 0 ? zzte.zzbtq : new zztj(this.zzbtx, zzug(), zzb);
    }

    public final boolean zzue() {
        int zzug = zzug();
        return C4468ih.m22091a(this.zzbtx, zzug, size() + zzug);
    }
