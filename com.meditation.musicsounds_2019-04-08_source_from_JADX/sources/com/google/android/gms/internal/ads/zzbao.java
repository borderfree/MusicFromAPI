...
class zzbao extends zzban {
    ...
    public final void zza(C4118zg zgVar) {
        zgVar.mo13838a(this.zzdpw, zzabh(), size());
    }
    ...
    public final boolean zzabe() {
        int zzabh = zzabh();
        return ade.m15886a(this.zzdpw, zzabh, size() + zzabh);
    }

    public final C4124zm zzabf() {
        return C4124zm.m20433a(this.zzdpw, zzabh(), size(), true);
    }
    ...
    public final int zzc(int i, int i2, int i3) {
        return aak.m15378a(i, this.zzdpw, zzabh(), i3);
    }
