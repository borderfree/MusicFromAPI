...
public final class C4075xs {
    /* renamed from: a */
    public static int m20333a(EllipticCurve ellipticCurve) {
        return (m20340b(ellipticCurve).subtract(BigInteger.ONE).bitLength() + 7) / 8;
    }

    /* renamed from: a */
    public static KeyPair m20334a(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) C4078xv.f15059d.mo13822a("EC");
        keyPairGenerator.initialize(eCParameterSpec);
        return keyPairGenerator.generateKeyPair();
    }

    /* renamed from: a */
    public static ECPublicKey m20335a(zzayv zzayv, byte[] bArr, byte[] bArr2) {
        ECParameterSpec a = m20336a(zzayv);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        m20338a(eCPoint, a.getCurve());
        return (ECPublicKey) ((KeyFactory) C4078xv.f15060e.mo13822a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, a));
    }

    /* renamed from: a */
    public static ECParameterSpec m20336a(zzayv zzayv) {
        String str;
        String str2;
        String str3;
        String str4;
        String str5;
        switch (C4076xt.f15052b[zzayv.ordinal()]) {
            case 1:
        ...
        return m20337a(str, str2, str3, str4, str5);
    }

    /* renamed from: a */
    private static ECParameterSpec m20337a(String str, String str2, String str3, String str4, String str5) {
        BigInteger bigInteger = new BigInteger(str);
        return new ECParameterSpec(new EllipticCurve(new ECFieldFp(bigInteger), bigInteger.subtract(new BigInteger("3")), new BigInteger(str3, 16)), new ECPoint(new BigInteger(str4, 16), new BigInteger(str5, 16)), new BigInteger(str2), 1);
    }

    /* renamed from: a */
    static void m20338a(ECPoint eCPoint, EllipticCurve ellipticCurve) {
        BigInteger b = m20340b(ellipticCurve);
    ...
    /* renamed from: a */
    public static byte[] m20339a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) {
        BigInteger bigInteger;
        m20338a(eCPoint, eCPrivateKey.getParams().getCurve());
        ECParameterSpec params = eCPrivateKey.getParams();
        params.getCurve();
        PublicKey generatePublic = KeyFactory.getInstance("EC").generatePublic(new ECPublicKeySpec(eCPoint, params));
        KeyAgreement keyAgreement = (KeyAgreement) C4078xv.f15058c.mo13822a("ECDH");
        keyAgreement.init(eCPrivateKey);
        keyAgreement.doPhase(generatePublic, true);
        byte[] generateSecret = keyAgreement.generateSecret();
        EllipticCurve curve = eCPrivateKey.getParams().getCurve();
        BigInteger bigInteger2 = new BigInteger(1, generateSecret);
        if (bigInteger2.signum() == -1 || bigInteger2.compareTo(m20340b(curve)) != -1) {
            throw new GeneralSecurityException("shared secret is out of range");
        }
        BigInteger b = m20340b(curve);
    ...
    /* renamed from: b */
    private static BigInteger m20340b(EllipticCurve ellipticCurve) {
