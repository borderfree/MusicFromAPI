...
public enum zzbbj {
    ...
    /* renamed from: O */
    private static final zzbbj[] f15413O = null;

    /* renamed from: P */
    private static final Type[] f15414P = null;

    /* renamed from: id */
    private final int f15442id;
    ...
    static {
        ...
        f15414P = new Type[0];
        zzbbj[] values = values();
        f15413O = new zzbbj[values.length];
        for (zzbbj zzbbj : values) {
            f15413O[zzbbj.f15442id] = zzbbj;
        }
    }
