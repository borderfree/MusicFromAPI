...
public abstract class ano extends ahn implements ann {
    public ano() {
    ...
    public final boolean dispatchTransaction(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) {
        ...
        L_0x003e:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.ano.dispatchTransaction(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
