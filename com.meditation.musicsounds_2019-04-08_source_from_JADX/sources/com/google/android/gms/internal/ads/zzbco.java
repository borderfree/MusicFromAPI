...
public final class zzbco<K, V> extends LinkedHashMap<K, V> {
    ...
    /* renamed from: a */
    private static final zzbco f15445a;
    ...
    /* renamed from: a */
    private static int m20748a(Object obj) {
        if (obj instanceof byte[]) {
            return aak.m15387c((byte[]) obj);
        }
    ...
    public final int hashCode() {
        ...
        for (Entry entry : entrySet()) {
            i += m20748a(entry.getValue()) ^ m20748a(entry.getKey());
        }
        return i;
    }
