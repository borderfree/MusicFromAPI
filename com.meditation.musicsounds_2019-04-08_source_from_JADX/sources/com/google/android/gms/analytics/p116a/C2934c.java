...
public class C2934c {
    ...
    /* renamed from: a */
    private Map<String, String> f10362a = new HashMap();

    /* renamed from: a */
    public final Map<String, String> mo10597a(String str) {
        HashMap hashMap = new HashMap();
        for (Entry entry : this.f10362a.entrySet()) {
    ...
    public String toString() {
        return C2950n.m13816a((Map) this.f10362a);
    }
}
