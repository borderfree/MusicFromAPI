...
public final class C4970w {

    /* renamed from: b */
    private static C4970w f17791b;

    /* renamed from: a */
    final Queue<Intent> f17792a = new ArrayDeque();
    @GuardedBy("serviceClassNames")

    /* renamed from: c */
    private final C0510m<String, String> f17793c = new C0510m<>();

    /* renamed from: d */
    private Boolean f17794d = null;

    /* renamed from: e */
    private final Queue<Intent> f17795e = new ArrayDeque();

    private C4970w() {
    }

    /* renamed from: a */
    public static PendingIntent m24660a(Context context, int i, Intent intent, int i2) {
        return PendingIntent.getBroadcast(context, i, m24663b(context, "com.google.firebase.MESSAGING_EVENT", intent), 1073741824);
    }

    /* renamed from: a */
    public static synchronized C4970w m24661a() {
        C4970w wVar;
        synchronized (C4970w.class) {
            if (f17791b == null) {
                f17791b = new C4970w();
            }
            wVar = f17791b;
    ...
    /* renamed from: a */
    public static void m24662a(Context context, Intent intent) {
        context.sendBroadcast(m24663b(context, "com.google.firebase.INSTANCE_ID_EVENT", intent));
    }

    /* renamed from: b */
    private static Intent m24663b(Context context, String str, Intent intent) {
    ...
    /* renamed from: b */
    public static void m24664b(Context context, Intent intent) {
        context.sendBroadcast(m24663b(context, "com.google.firebase.MESSAGING_EVENT", intent));
    }
    ...
    private final int m24665c(android.content.Context r7, android.content.Intent r8) {
        /*
            r6 = this;
            android.support.v4.g.m<java.lang.String, java.lang.String> r0 = r6.f17793c
            monitor-enter(r0)
            android.support.v4.g.m<java.lang.String, java.lang.String> r1 = r6.f17793c     // Catch:{ all -> 0x0143 }
        ...
        L_0x0057:
            ...
            r1.<init>(r2)
        L_0x005c:
            android.support.v4.g.m<java.lang.String, java.lang.String> r2 = r6.f17793c
            monitor-enter(r2)
            android.support.v4.g.m<java.lang.String, java.lang.String> r3 = r6.f17793c     // Catch:{ all -> 0x006a }
        ...
        L_0x00d7:
            java.lang.Boolean r1 = r6.f17794d     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
        ...
        L_0x00e4:
            ...
            r6.f17794d = r0     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
        L_0x00ea:
            java.lang.Boolean r0 = r6.f17794d     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
            boolean r0 = r0.booleanValue()     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
            if (r0 == 0) goto L_0x00f7
            android.content.ComponentName r7 = android.support.p009v4.content.C0461f.m2106a_(r7, r8)     // Catch:{ SecurityException -> 0x0138, IllegalStateException -> 0x0110 }
            goto L_0x0102
        L_0x00f7:
        ...
        L_0x0143:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.C4970w.m24665c(android.content.Context, android.content.Intent):int");
    }

    /* renamed from: a */
    public final int mo16244a(Context context, String str, Intent intent) {
        Queue<Intent> queue;
        ...
        return m24665c(context, intent2);
    }

    /* renamed from: b */
    public final Intent mo16245b() {
        return (Intent) this.f17795e.poll();
    }
}
