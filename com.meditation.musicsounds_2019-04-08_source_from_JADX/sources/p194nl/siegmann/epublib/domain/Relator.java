...
/* renamed from: nl.siegmann.epublib.domain.Relator */
public enum Relator {
    ACTOR("act", "Actor"),
    ADAPTER("adp", "Adapter"),
    ANALYST("anl", "Analyst"),
    ...
    private Relator(String str, String str2) {
        this.code = str;
        this.name = str2;
    }

    public static Relator byCode(String str) {
        Relator[] values;
        for (Relator relator : values()) {
            if (relator.getCode().equalsIgnoreCase(str)) {
                return relator;
            }
        }
        return null;
