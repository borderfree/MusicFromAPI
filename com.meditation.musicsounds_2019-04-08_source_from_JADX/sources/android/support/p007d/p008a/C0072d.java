...
public class C0072d {
    ...
    public static android.view.animation.Interpolator m186a(android.content.Context r4, int r5) {
        /*
        ...
        L_0x000b:
            ...
            android.support.v4.view.b.a r4 = new android.support.v4.view.b.a     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
        ...
        L_0x001e:
            ...
            android.support.v4.view.b.b r4 = new android.support.v4.view.b.b     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            return r4
        L_0x0029:
            r1 = 17563662(0x10c000e, float:2.5713978E-38)
            if (r5 != r1) goto L_0x0034
            android.support.v4.view.b.c r4 = new android.support.v4.view.b.c     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x001c, IOException -> 0x001a }
            return r4
        L_0x0034:
            ...
            android.view.animation.Interpolator r4 = m187a(r4, r0, r2, r1)     // Catch:{ XmlPullParserException -> 0x0054, IOException -> 0x0051, all -> 0x004e }
        ...
        L_0x0098:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p007d.p008a.C0072d.m186a(android.content.Context, int):android.view.animation.Interpolator");
    }

    /* renamed from: a */
    private static Interpolator m187a(Context context, Resources resources, Theme theme, XmlPullParser xmlPullParser) {
        Interpolator gVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            gVar = new C0077g(context, asAttributeSet, xmlPullParser);
                        } else {
